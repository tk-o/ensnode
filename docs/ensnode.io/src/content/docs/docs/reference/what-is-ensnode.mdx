...
1. **Full Backwards Compatibility w/ ENS Subgraph**
   ...
   - Verified compatibility through extensive testing with [`ens-test-env`](https://github.com/namehash/ens-test-env/) and [ens-subgraph-transition-tools](https://github.com/namehash/ens-subgraph-transition-tools) (see [Subgraph Compatibility](/docs/reference/what-is-the-ens-subgraph))
