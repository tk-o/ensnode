...
<LinkCard
  ...
  description="Learn more about how ENSRainbow's versioning system works"
/>
...
<LinkCard
  ...
  description="Step-by-step guide for setting up ENSRainbow locally"
/>

<LinkCard
  title="Configuration Guide"
  href="/docs/services/ensrainbow/usage/configuration"
  description="Complete configuration options for ENSRainbow deployment"
/>

<LinkCard
  title="TypeScript Interfaces"
  href="/docs/services/ensrainbow/concepts/typescript-interfaces"
  description="Type definitions for label sets in the ENSRainbow SDK"
/>
