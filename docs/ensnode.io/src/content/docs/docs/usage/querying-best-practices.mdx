...
:::note[REPLACE_UNNORMALIZED]
The following is relevant when `REPLACE_UNNORMALIZED=true` and ENSNode is following legacy ENS Subgraph logic for handling unknown labels.
:::
