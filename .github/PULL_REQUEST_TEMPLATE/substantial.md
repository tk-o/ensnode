...
- Why this change is happening _now_
...
Describe what changed _after_ you reviewed your own diff end-to-end.
...
- What important behavior is _not_ covered by tests
...
- [ ] Relevant changesets are included (or are not required)
  - _Tip: [Changesets](https://ensnode.io/docs/contributing/releases#adding-a-changeset-to-your-pr) should be created / written to optimize for the narrative of the next autogenerated [release notes](https://github.com/namehash/ensnode/releases)._
