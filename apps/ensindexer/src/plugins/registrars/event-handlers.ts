...
import attach_Ethnames_UniversalRegistrarRenewalWithReferrer from "./ethnames/handlers/Ethnames_UniversalRegistrarRenewalWithReferrer";
...
export default function () {
  ...
  attach_Ethnames_UniversalRegistrarRenewalWithReferrer();
