...
describe('ENS Rainbow API', () => {
    ...
    describe('GET /v1/count', () => {
        ...
        it('should return correct count of entries', async () => {
            // Add some test data
            const testData = [
                { hash: '0x1111111111111111111111111111111111111111111111111111111111111111', label: 'test1' },
                { hash: '0x2222222222222222222222222222222222222222222222222222222222222222', label: 'test2' },
                { hash: '0x3333333333333333333333333333333333333333333333333333333333333333', label: 'test3' }
            ];
