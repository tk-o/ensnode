export default [
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: "uint256", name: "maxMintBatchSize", type: "uint256" },
    ],
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: "address", name: "priceOracle", type: "address" }],
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: "address", name: "tokenURIProvider", type: "address" },
    ],
  ...
  },
  {
    inputs: [],
    name: "getMintState",
    outputs: [{ internalType: "enum IEFPListRegistry.MintState", name: "", type: "uint8" }],
    stateMutability: "view",
    type: "function",
  },
  {
  ...
  },
  {
    inputs: [
      { internalType: "address", name: "recipient", type: "address" },
      { internalType: "bytes", name: "listStorageLocation", type: "bytes" },
    ],
    name: "mintTo",
    outputs: [],
    stateMutability: "payable",
  ...
  {
    inputs: [{ internalType: "uint256", name: "_maxMintBatchSize", type: "uint256" }],
  ...
  {
    inputs: [
      { internalType: "enum IEFPListRegistry.MintState", name: "_mintState", type: "uint8" },
    ],
    name: "setMintState",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  {
    inputs: [{ internalType: "address", name: "priceOracle_", type: "address" }],
    name: "setPriceOracle",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  ...
  {
    inputs: [{ internalType: "address", name: "tokenURIProvider_", type: "address" }],
  ...
  },
  {
    ...
    outputs: [{ internalType: "contract ITokenURIProvider", name: "", type: "address" }],
    stateMutability: "view",
    type: "function",
  },
  {
